...
<%
	...
	String str = "INSERT INTO tbl_complains (cid, cust_id, cust_name, comp_type, comp_title, comp_desc, status, eng_id, eng_name, eng_comment, create_date, close_date) VALUES (NULL, '"+session.getAttribute("user_id")+"', '"+session.getAttribute("user_name")+"', '"+request.getParameter("compType")+"', '"+request.getParameter("compTitle")+"', '"+request.getParameter("compDesc")+"', 'open', 0, '' , '', NOW(), '0001-01-01 01:01:01' )";
				//out.print(str);	
		      ...
		      <tr><th>Your Complain Created.</th></tr>
