...
<%
	...
	String str = "INSERT INTO tbl_customer (cname, cpass, address, email, c_mobile, date_time) VALUES ('"+request.getParameter("CustomerName")+"', '"+request.getParameter("Password")+"', '"+request.getParameter("Address")+"', '"+request.getParameter("Email")+"', '"+request.getParameter("Mobile")+"', NOW())";
