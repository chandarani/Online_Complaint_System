...
<%
	...
	String str = "SELECT * FROM tbl_complains WHERE status != 'close' AND eng_id ='"+session.getAttribute("user_id")+"'	ORDER BY create_date DESC";
...
<form action="processLeave.php?action=addUser" method="post"  name="frmListUser" id="frmListUser">
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="text">
    ...
    <tr style="height:25px;">
      ...
      <td width="260" align="center"><% out.print(rs.getString("comp_type"));%></td>
      <td width="139" align="center"><% out.print(rs.getString("status"));%></td>
      <td width="150" align="center"><a href="empViewByCompID.jsp?cid=<% out.print(rs.getString("cid"));%>">Detail</a></td>
    </tr>
    <%
	} // end while
	%>
 ...
 out.print("<h3><font color=red>No Complains Assign to You.</font></h3>");
 }
 %> 
  <p>&nbsp;</p>
</form>
