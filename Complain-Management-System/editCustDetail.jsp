...
<%
	...
	String str = "SELECT * FROM tbl_customer where cid='"+request.getParameter("cust_id")+"'";
	rs = statement.executeQuery(str);
	rs.next();
%>
<h3>Edit Customer Details - Admin View</h3>
<form action="processEditCust.jsp" method="post"  name="frmListUser" id="frmListUser">
      ...
      <td class="contentArea"><div class="errorMessage" align="center"></div>
          <table width="100%" border="0" cellpadding="2" cellspacing="1" class="text">
            <tr align="center">
			  ...
			  <input type="hidden" name="cid" value="<% out.print(request.getParameter("cust_id"));%>" />
			  </div></td>
            </tr>
            <tr class="entryTable">
              <td class="label">&nbsp;Customer Name</td>
              <td class="content"><input name="CustomerName" type="text" class="box" id="CustomerName" size="30" maxlength="20"  value="<% out.print(rs.getString("cname"));%>" /></td>
            </tr>
            <tr class="entryTable">
              <td class="label">&nbsp;Password</td>
              <td class="content"><input name="Password" type="text" class="box" id="Password" value="<% out.print(rs.getString("cpass"));%>" size="30" maxlength="20" /></td>
            </tr>
            <tr class="entryTable">
            ...
            <tr class="entryTable">
              ...
              <td class="content"><input name="Email" type="text" class="box" id="Email" value="<% out.print(rs.getString("email"));%>" size="30" maxlength="40" /></td>
            </tr>
            <tr class="entryTable">
              <td class="label">&nbsp;Mobile No. </td>
              <td class="content"><input name="Mobile" type="text" class="box" id="Mobile" value="<% out.print(rs.getString("c_mobile"));%>" size="30" maxlength="60" /></td>
            </tr>
            <tr>
              <td width="200">&nbsp;</td>
              <td width="372">&nbsp;</td>
            ...
            <tr>
              <td>&nbsp;</td>
              <td><input name="btnLogin" type="submit" id="btnLogin" onclick="MM_validateForm('CustomerName','','R','Email','','RisEmail','Mobile','','R','Address','','R','Password','','R');return document.MM_returnValue" value=" Update Now "></td>
            </tr>
        </table></td>
    </tr>
  </table>
