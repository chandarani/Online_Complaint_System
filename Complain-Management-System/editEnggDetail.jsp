...
<%
	...
	String str = "SELECT * FROM tbl_engineer where eid='"+request.getParameter("eng_id")+"'";
	rs = statement.executeQuery(str);
	rs.next();
%>
<h3>Edit Engineer Details - Admin View</h3>
<form action="processEditEngg.jsp" method="post"  name="frmListUser" id="frmListUser">
      ...
      <td class="contentArea"><div class="errorMessage" align="center"><?php //echo $errorMessage; ?></div>
          <table width="100%" border="0" cellpadding="2" cellspacing="1" class="text">
            <tr align="center">
			  ...
			  <input type="hidden" name="eid" value="<% out.print(rs.getString("eid"));%>" />
			  </div></td>
            </tr>
            <tr class="entryTable">
              <td class="label">&nbsp;Engg, Name</td>
              <td class="content"><input name="EngineerName" type="text" class="box" id="EngineerName" size="30" maxlength="20"  value="<% out.print(rs.getString("ename"));%>"/></td>
            </tr>
            <tr class="entryTable">
              <td class="label">&nbsp;Password</td>
              <td class="content"><input name="Password" type="text" class="box" id="Password" value="<% out.print(rs.getString("epass"));%>" size="30" maxlength="20"  /></td>
            </tr>
            <tr class="entryTable">
            ...
            <tr class="entryTable">
              ...
              <td class="content">
			  <input name="Email" type="text" class="box" id="Email" value="<% out.print(rs.getString("email"));%>" size="30" maxlength="20" /></td>
            </tr>
            <tr class="entryTable">
              <td class="label">&nbsp;Mobile No. </td>
              <td class="content">
			  <input name="Mobile" type="text" class="box" id="Mobile" value="<% out.print(rs.getString("e_mobile"));%>" size="30" maxlength="60" /></td>
            </tr>
            <tr>
              <td width="200">&nbsp;</td>
              <td width="372">&nbsp;</td>
            ...
            <tr>
              <td>&nbsp;</td>
              <td><input name="btnLogin" type="submit" id="btnLogin" onclick="MM_validateForm('EngineerName','','R','Email','','RisEmail','Mobile','','R','Address','','R','Password','','R');return document.MM_returnValue" value=" Edit "></td>
            </tr>
        </table></td>
    </tr>
  </table>
