...
<p>To add New Customer <a href="addCust.jsp">Click Here</a> </p>

<form action="processAddUser.jsp" method="post"  name="frmListUser" id="frmListUser">
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="text">
	...
	String str = "SELECT * FROM tbl_customer ORDER BY cname ASC";
	rs = statement.executeQuery(str);
	//$cust_id = (int)$_SESSION['user_id'];
	while(rs.next()){
	%>
    <tr style="height:25px;">
      <td>&nbsp;<% out.print(rs.getString("cname")); %></td>
      <td><% out.print(rs.getString("email")); %></td>
      <td><% out.print(rs.getString("c_mobile")); %></td>
      <td><a href="editCustDetail.jsp?cust_id=<% out.print(rs.getString("cid")); %>">Edit</a> / <a href="deleteCust.jsp?cust_id=<% out.print(rs.getString("cid")); %>">Delete</a> </td>
    </tr>
    <%
	} // end while
	%>
