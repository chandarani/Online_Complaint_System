...
<form action="processLeave.jsp?action=addUser" method="post"  name="frmListUser" id="frmListUser">
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="text">
	...
	String str = "SELECT * FROM tbl_complains WHERE status != 'close' ORDER BY create_date DESC";
    ...
    <tr style="height:25px;">
      ...
      <td><% out.print(rs.getString("comp_type")); %></td>
      <td><% out.print(rs.getString("status")); %></td>
      <td><a href="viewByCompID.jsp?compid=<% out.print(rs.getString("cid")); %>">Detail</a></td>
    </tr>
    <%
	} // end while
	%>
