...
<%
	...
	String str = "UPDATE tbl_customer SET cname = '"+request.getParameter("CustomerName")+"', cpass = '"+request.getParameter("Password")+"', address = '"+request.getParameter("Address")+"', email = '"+request.getParameter("Email")+"', c_mobile = '"+request.getParameter("Mobile")+"' WHERE cid = '"+request.getParameter("cid")+"'";
