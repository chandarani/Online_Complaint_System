...
<%
	...
	String str = "UPDATE tbl_engineer SET ename = '"+request.getParameter("EngineerName")+"', epass = '"+request.getParameter("Password")+"', address = '"+request.getParameter("Address")+"', email = '"+request.getParameter("Email")+"', 	e_mobile = '"+request.getParameter("Mobile")+"' WHERE eid = '"+request.getParameter("eid")+"'";
		      ...
		      <tr><th>Data Updated successfully in database.</th></tr>
